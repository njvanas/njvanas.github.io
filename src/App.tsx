...
import { UserCircle2, Briefcase, FolderKanban, Mail, Code, Rocket, Award, Terminal, Brain, Coffee, Database, Globe, Cpu, Users } from 'lucide-react';
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4">
                ...
                <QuickCard
                  ...
                  description="Community-driven travel planning app"
                  href="#projects/travel-social"
                />
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4">
                ...
                <QuickCard
                  ...
                  description="Designed cloud-native infrastructure"
                  href="#experience/architect"
                />
                <QuickCard
                  icon={<Users className="w-6 h-6" />}
                  title="Team Lead"
                  description="Led 15+ developer team"
                  href="#experience/team-lead"
                />
              </div>
            </div>
          </div>
